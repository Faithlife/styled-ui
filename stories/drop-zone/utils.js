...
export const DroppedFiles = styled.div`
	margin-top: 16px;
`;

export const CustomDropZoneMessage = styled.div`
	font-size: 20px;
	max-width: 240px;
	text-align: center;
`;
...
export const CustomDropZoneIcons = () => (
	<IconsContainer>
		<svg
			stroke="currentColor"
			fill="currentColor"
...
export const handleDrop = setState => dropEvent => {
	...
	setState(prevState => [...prevState, ...fileNames]);
};
