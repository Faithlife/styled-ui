...
1. Update [`VersionHistory.md`](/VersionHistory.md) and stage the changes in git.
2. Run `yarn version`, following [semantic versioning](https://semver.org/) when choosing the new version number.
3. Push the commit generated by `yarn version` to `master`.
4. Go to [this Jenkins build page](https://jenkins.lrscorp.net/view/Community/job/styled-ui%20publish/build?delay=0sec) and click "Build".
