...
export class GroupSelectorSearch extends React.Component {
	static propTypes = {
		...
		/** Whether or not the search is embedded in a modal */
	...
	toggle = () => {
		...
		if (this.props.onChangeModalState) {
	...
	render() {
		...
		return (
			<Styled.GroupSelectorModal>
				{(this.state.modalContent === 'main' || !this.props.isInModal) && (
				...
				{this.state.modalContent === 'admin' && this.props.isInModal && adminModalView}
				...
				{this.state.modalContent === 'change' && this.props.isInModal && changeModalView}
